...
import tokenIdsList from '../alpha.json' assert { type: "json" };
// import tokenIdsList from '../epic.json' assert { type: "json" };

// 3. Create a new array of `leafNodes` by hashing all indexes of the `tokenIdsList`
...
console.log("hexProof for", claimingAddress, hexProof);
